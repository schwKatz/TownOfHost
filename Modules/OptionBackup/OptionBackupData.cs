...
namespace TownOfHostY
{
    public class OptionBackupData
    {
        ...
        public OptionBackupData(IGameOptions option)
        {
            ...
            foreach (RoleTypes role in new RoleTypes[] { RoleTypes.Scientist, RoleTypes.Engineer, RoleTypes.Tracker, RoleTypes.Noisemaker, RoleTypes.GuardianAngel, RoleTypes.Shapeshifter, RoleTypes.Phantom })
            {
