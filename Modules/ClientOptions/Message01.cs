...
public static class Message01
{
    ...
    public static void Init(OptionsMenuBehaviour optionsMenuBehaviour)
    {
        ...
        UnloadButton.transform.localPosition = new(0f, -1f, -2f);
        //UnloadButton.Background.color = UnloadButton.Text.color = Color.red;
        UnloadButton.Text.text = Translator.GetString("Close");
        ...
        {
            Main.CanPublicRoom.Value = false;
            Hide();
        }));
    }
    ...
    public static void Show()
    {
        if (Popup != null)
        {
            ...
            {
                WarnText.text = Translator.GetString("CannotChangeDuringGame");
                UnloadButton.gameObject.SetActive(false);
            }
            else
            {
                WarnText.text = Translator.GetString("DisabledByProgram");
