...
namespace TownOfHost
{
    ...
    class HandleHUDPatch
    {
        public static void Postfix(Rewired.Player player)
        {
            ...
            (PlayerControl.LocalPlayer.GetCustomRole() is CustomRoles.Sheriff or CustomRoles.Arsonist or CustomRoles.Jackal or CustomRoles.ISchrodingerCat or CustomRoles.EgoSchrodingerCat or CustomRoles.JSchrodingerCat) && PlayerControl.LocalPlayer.Data.Role.Role != RoleTypes.GuardianAngel)
            {
