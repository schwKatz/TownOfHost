    ...
    {
        {
            var news = new ModNews
            {
                Number = 100015,
                //BeforeNumber = 0,
                Title = "『Yumeno-Stream-Ship』開催！",
                SubTitle = "【総勢28人】ゆめの主催TOH_Y配信者Among Us",
                ShortTitle = "TOH_Y配信者が勢揃い！",
                Text = "<b>各参加者視点からぜひご視聴ください</b>"
                + "\n　C船 最大12人、V船 最大15人の試合をゆめのがメイキング！夢のようなTOH_Y配信者だらけのAmong Usを8/5(土)、8/27(日)に開催します！"
                + "\n　新役職「はぐれ狼」を初めとした新役職入りを予定しています(!?)\n"
                + "\n　メンバーは下の青文字からチェック！(Twitter/X)"
                + $"\n　Ｃ船：8/5(土)19:00～23:00　<link={"https://twitter.com/yumeno_AmongUs/status/1685819860834816002?s=20"}>メンバー詳細</link>"
                + $"\n\n　Ｖ船：8/27(日)20:30～25:00　<link={"https://twitter.com/yumeno_AmongUs/status/1685821718718468096?s=20"}>メンバー詳細</link>"
                + "\n\n----------------------------------------------------------------"
                + "\n<b>Ｃ船メンバーのチャンネルはここから飛べるよ</b>"
                + $"\n　・Yumeno　<link={"https://youtube.com/@Yumenopai"}>Youtube</link>"
                + $"\n\n　・くろにゃんこch　<link={"https://youtube.com/@SwKatz"}>Youtube</link>"
                + $"\n\n　・カッツェ　<link={"https://youtube.com/@katzech"}>Youtube</link>"
                + $"\n\n　・虎タイガー　<link={"https://youtube.com/@user-xm2vp4lo7h"}>Youtube</link>"
                + $"\n\n　・あすちゃんねる　<link={"https://youtube.com/@ASkunAS"}>Youtube</link>"
                + $"\n\n　・ペルさん【ゆっくり実況】　<link={"https://youtube.com/@aoon32_perusan"}>Youtube</link>"
                + $"\n\n　・もわくん!　<link={"https://youtube.com/@mowakundayo"}>Youtube</link>"
                + $"\n\n　・クェルボ公爵　<link={"https://youtube.com/@Duke_Cuervo"}>Youtube</link>"
                + $"\n\n　・芹野ナツキ　<link={"https://youtube.com/@NatsukiSerino"}>Youtube</link>"
                + $"\n\n　・ラグドールP　<link={"https://youtube.com/@ragdollPch"}>Youtube</link>"
                + $"\n\n　・Tミノ　<link={"https://twitter.com/T_TETRIMINO"}>Twitter/X</link>"
                + $"\n\n　・天狗のマクロバースト　<link={"https://twitter.com/9s9NqnxkTmnzkKj"}>Twitter/X</link>"
                + $"\n\n　・めーぷる　<link={"https://twitter.com/meiple_meiple"}>Twitter/X</link>"
                + $"\n\n　・りぃりぃ　<link={"https://twitter.com/rixirixi0202"}>Twitter/X</link>"

                + "\n\n\nなにか気になったことやバグ報告はTOH_YのDiscordまでご連絡ください。\n\nTown Of Host_Y：Yumeno",
                Date = "2023-08-3T00:00:00Z"
